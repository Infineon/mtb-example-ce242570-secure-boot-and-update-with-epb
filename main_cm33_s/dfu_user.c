...
static bool AddressValid(uint32_t address, cy_stc_dfu_params_t *params)
{
    ...
    ((CY_EXT_NVM1_BASE <= address) && (address < (CY_EXT_NVM1_BASE + CY_EXT_NVM1_SIZE)));
        CY_UNUSED_PARAMETER(params);
            ...
            addrValid = ((CYMEM_CM33_0_S_m33s_secondary_slot_S_START <= address) && (address < (CYMEM_CM33_0_S_m33s_secondary_slot_S_START + CYMEM_CM33_0_S_m33s_secondary_slot_SIZE))) ||
                        ((CYMEM_CM33_0_S_ppca0_secondary_slot_S_START <= address) && (address < (CYMEM_CM33_0_S_ppca0_secondary_slot_S_START + CYMEM_CM33_0_S_ppca0_secondary_slot_SIZE))) ||
                        ((CYMEM_CM33_0_S_ppca1_secondary_slot_S_START <= address) && (address < (CYMEM_CM33_0_S_ppca1_secondary_slot_S_START + CYMEM_CM33_0_S_ppca1_secondary_slot_SIZE)));
            CY_UNUSED_PARAMETER(params);
        #endif /* CY_IP_M7CPUSS */
    #endif /* (CY_DFU_OPT_EXTERNAL_MEMORY != 0U) */
#endif /* CY_DFU_FLOW == CY_DFU_BASIC_FLOW */
